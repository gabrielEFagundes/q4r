...
use crate::{backend::Backend, expdesc::{ComparisonDeclaration, DeclType, ExpLiteral, ExpOperator, ExpType::self, FunCall, FunDeclaration, VarDeclaration}, internals::{q4r_expressions, q4r_functions, q4r_statements, q4r_values, q4r_variables}, signature::{Signature}};
...
pub trait Codegen<'a>{
    fn signed_number(backend: &mut Backend<'a>) -> ExpLiteral{
        q4r_values::signed_literal(backend)
    }
